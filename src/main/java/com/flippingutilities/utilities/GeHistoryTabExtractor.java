...
public class GeHistoryTabExtractor {
    ...
    public static OfferEvent createOfferEventFromWidgetGroup(List<Widget> widgets) {
        ...
        OfferEvent offerEvent = new OfferEvent(UUID.randomUUID().toString(), isBuy, itemId, quantity, price, time, slot, offerState, tickArrivedAt, ticksSinceFirstOffer, totalQuantity, true, null, false, null, null,0,0);
        return offerEvent;
    }
