...
public class GeHistoryTabExtractor {
    ...
    public static OfferEvent createOfferEventFromWidgetGroup(List<Widget> widgets) {
        ...
        OfferEvent offerEvent = new OfferEvent(isBuy, itemId, quantity, price, time, slot, offerState, tickArrivedAt, ticksSinceFirstOffer, totalQuantity, true, null, null, false, null,0);
        return offerEvent;
    }
